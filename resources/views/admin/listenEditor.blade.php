...
<div class="box box-warning">
    ...
    <div class="box-body">
        <form role="form" action="{{@url("/listen/update")}}" method="post">
            ...
            <div class="form-group">
                <label>诗词内容</label><br>
                <textarea id="tinyMCEEditor" name="sub_content" rows="10" cols="100" style="width: 100%;">{{$data->sub_content}}</textarea>
            </div>

            <div class="form-group">
                <label>详情</label>
                <textarea id="tinyMCEEditor_1" name="detail" rows="10" cols="80" >{{$data->detail}}</textarea>
            </div>
